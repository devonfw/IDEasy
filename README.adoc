...
To tweak the installation location (e.g. use a drive or partition with more disc-space) see https://github.com/devonfw/IDEasy/blob/main/documentation/setup.adoc#tweak-installation-location.
