...
For a detailed overview of the quality and support status of IDEasy tools across operating systems, see link:documentation/quality-status/quality-status.adoc[Quality Status] (link:documentation/quality-status/quality-status-windows.adoc[Windows]/link:documentation/quality-status/quality-status-macos.adoc[Mac]/link:documentation/quality-status/quality-status-linux.adoc[Linux]).
...
*If you want to contribute to `IDEasy` please read our link:documentation/contributing/README.adoc[Contributing Guidelines].*
