...
import com.devonfw.tools.ide.url.tool.git.GitUrlUpdater;
...
public class UpdateManager extends AbstractProcessorWithTimeout {
  ...
  private final List<AbstractUrlUpdater> updaters = List.of(
      ...
      new GcLogAnalyzerUrlUpdater(), new GCloudUrlUpdater(), new GcViewerUrlUpdater(), new GhUrlUpdater(), new GitUrlUpdater(), new GoUrlUpdater(),
      ...
      new QuarkusUrlUpdater(), new RubyUrlUpdater(), new RubyJdxUrlUpdater(), new RustUrlUpdater(), new DockerRancherDesktopUrlUpdater(), new SonarUrlUpdater(),
