...
/**
 * Interface for a merger responsible for merging {@link com.devonfw.tools.ide.tool.ide.IdeToolCommandlet IDE}
 * configuration files into the workspace.
 */
public interface WorkspaceMerger {
   ...
   * @param variables the {@link EnvironmentVariables} to {@link EnvironmentVariables#resolve(String, Object) resolve
   *        variables}.
   ...
   * @param variables the {@link EnvironmentVariables} to {@link EnvironmentVariables#inverseResolve(String, Object)
   *        inverse resolve variables}.
