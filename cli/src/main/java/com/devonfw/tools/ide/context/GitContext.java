...
public interface GitContext extends IdeLogger {
   ...
   * @param force boolean true enforces a git hard reset and cleanup of added files.
   */
  void pullOrClone(String gitRepoUrl, Path targetRepository, String remoteName, String branchName, boolean force);
   ...
   * @param branchName the name of the branch.
   */
  void pull(Path targetRepository, String remoteName, String branchName);
