...
/**
 * Data object for {@link MvnMetadata#getVersioning() versioning} of {@link MvnMetadata}.
 */
public class MvnVersioning {
   ...
   */
  public MvnVersioning(String latest, String release, List<String> versions, String lastUpdated) {
