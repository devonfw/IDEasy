...
/**
 * Test of {@link MavenVersioning}.
 */
class MavenVersioningTest extends Assertions {

  /**
   * Test of constructors, getters, and setters of {@link MavenVersioning}.
   */
  @Test
  void testMavenVersioning() {
    List<String> versions = Arrays.asList("1.0.0", "1.1.0", "2.0.0");
    MavenVersioning versioning = new MavenVersioning("2.0.0", "1.1.0", versions, "20250729");
