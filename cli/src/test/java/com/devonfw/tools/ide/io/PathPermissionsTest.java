...
public class PathPermissionsTest extends Assertions {
  ...
  public void testToPosix() {
    ...
    assertThat(PathPermissions.of(0b000000010).toPosix()).containsExactly(PosixFilePermission.OTHERS_WRITE);
    assertThat(PathPermissions.of(0b000000100).toPosix()).containsExactly(PosixFilePermission.OTHERS_READ);
    ...
    assertThat(PathPermissions.of(0b001000000).toPosix()).containsExactly(PosixFilePermission.OWNER_EXECUTE);
    assertThat(PathPermissions.of(0b010000000).toPosix()).containsExactly(PosixFilePermission.OWNER_WRITE);
