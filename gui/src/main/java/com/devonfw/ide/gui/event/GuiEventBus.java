 ...
 * for non-GUI logic as well. A listener that touches the scene graph has to hop to the FX thread itself (see
 * {@link com.devonfw.ide.gui.helper.FxHelper#runFxSafe(Runnable)}).
 */
