...
public class App extends Application {
    ...
    public void init() {
        ...
        configureMacOSDockTitle();
    }

    /**
     * Set the macOS dock icon label to "IDEasy" instead of the default process name "java". No-op on other platforms.
     */
    private void configureMacOSDockTitle() {

        if (SystemInfoImpl.INSTANCE.isMac()) {
            System.setProperty("apple.awt.application.name", "IDEasy");
        }
    }
