...
Obviously there are also the "app stores" that come with your operating system with graphical UI that we do not explicitly list here.

We believe to offer the perfect solution, if you want to automate the tool setup for your dev project and even maintain it over the project lifecycle with ease.
What is still unique about IDEasy is that we not only install tools but allow you to share your project configuration via a git repo that goes beyond simple tool installation and besides plugins it also automates the enitre configurations.
...
* https://mise.jdx.dev/[mise-en-place] - cross platform software installer as CLI
* https://github.com/jetify-com/devbox[devbox] - generic software installer as CLI based on nix, does not work native on Windows (https://github.com/jetify-com/devbox/issues/2235[yet]).
...
== Tool wrappers or version managers
...
* https://github.com/nvm-sh/nvm?tab=readme-ov-file#intro[nvm] - version manager for https://nodejs.org/[node.js]
* https://github.com/pyenv/pyenv[pyenv] - version manager for python, see also https://docs.python.org/3/library/venv.html[venv]
