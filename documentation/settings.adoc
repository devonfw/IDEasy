...
To use this approach simply copy the content of https://github.com/devonfw/ide-settings[ide-settings] to a top-level `settings` folder in your code repository.
You can then create the project as normal as IDEasy will automatically detect that you are using a code repository:
