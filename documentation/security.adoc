...
IDEasy has build-in support helping you to stay secure.
...
If such alternatives can be found, they will be printed out, and you can make a choice what install.
...
No CVEs found for nearest version 3.9.8 of tool mvn.
