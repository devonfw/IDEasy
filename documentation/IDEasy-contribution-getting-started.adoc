...
To set up the IDEasy development environment, run the following command at the Terminal after installation to create a project:
...
TODO explain:
* Properties * run Method * Dependencies * Commandlet class hierarchy
