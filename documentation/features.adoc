...
[cool-project]$ ide
Environment variables have been set for ~/projects/cool-project with workspace set to main (fallback to default)
[devonfw]$ mvn -v
...
[my-project]$ ide
Environment variables have been set for ~/projects/ide-test with workspace set to test
[my-project]$ mvn -v
