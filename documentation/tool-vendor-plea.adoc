...
Just to give an example https://www.python.org/[Python] is a tool that did not offer binary releases for Mac or Linux quite some time ago so users had to build it from the sources.
We got in touch with the python community and they now provide portable releases for all platforms. Thank you so much!
