...
For detailed information on implementing new commandlets and UrlUpdaters, see the comprehensive guide link:commandlet.adoc[Creating New Commandlets].

That guide covers:

* Understanding the architecture of commandlets
* When to use package manager ecosystems (npm, Maven, pip)
* Steps to implement and register new commandlets

== URL Updaters

For detailed information on implementing UrlUpdaters, see the comprehensive guide link:url-updater.adoc[Creating New UrlUpdaters].

That guide covers:

* Creating a custom UrlUpdater
* Choosing the right UrlUpdater base class (JsonUrlUpdater, GithubUrlReleaseUpdater, etc.)
* Steps to implement and register new UrlUpdaters
