...
To create a launch configuration, open the *Run and Debug* panel (kbd:[Ctrl+Shift+D]) and select *create a launch.json file*. This will automatically create a ready-to-go launch configuration that you can modify with relevant launch arguments.
