...
```
+
For Capgemini developers with access to the IDEasy settings repository:
+
```
ide create IDEasy https://assets.engine.capgemini.com/engine_hohwille/ideasy-settings.git
```
