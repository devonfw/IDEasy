...
image::images/wsl_guide/WindowsSearch.jpg["WindowsSearch"]

You should now be able to access the Ubuntu terminal on your system.

.Ubuntu Terminal
image::images/wsl_guide/UbuntuTerminal.jpg["UbuntuTerminal"]
...
.Download and verify files with wget and ls
image::images/wsl_guide/wget.jpg["wget"]
