...
* https://github.com/devonfw/IDEasy/issues/1169[#1169]: mklink fails if link already exists - Fixed Windows junction creation failure when broken junction exists
