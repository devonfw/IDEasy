...
* https://github.com/devonfw/IDEasy/issues/1292[#1292]: logs potential welcome file in settings dir to info level
...
* https://github.com/devonfw/IDEasy/issues/736[#736]: Resolved issue with handling of special characters in plugin names
