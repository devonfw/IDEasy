...
* https://github.com/devonfw/IDEasy/issues/2436[#2436]: Fix plugin installation progress when plugins are already installed and remove duplicate success messages
