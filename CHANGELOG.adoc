...
* https://github.com/devonfw/homebrew-IDEasy/issues/4[homebrew-IDEasy#4]: Publish the Homebrew formula as part of the release so `brew upgrade ideasy` gets new versions
