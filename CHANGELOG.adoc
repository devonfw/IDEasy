...
* https://github.com/devonfw/IDEasy/issues/1351[#1729]: Jline update fix.
Installed version of Jline: 3.30.6 ProgressBar version changed to 0.10.2 Dependencies jline-terminal and jline-native were added explicitly.
