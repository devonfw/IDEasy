...
* https://github.com/devonfw/IDEasy/issues/2484[#2484]: Tab completion for ide install python <version> triggers uv installation/update
...
* https://github.com/devonfw/IDEasy/issues/2484[#2484]: Do not trigger uv installation on python version auto-completion
