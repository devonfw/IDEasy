...
* https://github.com/devonfw/IDEasy/issues/2344[#2344]: Aligned the macOS PKG build script with the Windows MSI build script (moved to `macos-installer/build-pkg.sh`) and added the macOS installer README
