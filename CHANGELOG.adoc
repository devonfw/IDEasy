...
* https://github.com/devonfw/IDEasy/issues/2442[#2442]: Made the Windows installer a Maven module (`windows-installer/pom.xml`) to align it with the macOS installer
