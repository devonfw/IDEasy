...
* https://github.com/devonfw/IDEasy/issues/451[#451]: Fix macOS Gatekeeper blocking the IDEasy binary: ad-hoc sign it in the release build and remove the quarantine attribute in setup
