...
* https://github.com/devonfw/IDEasy/issues/1751[#1751]: Add go-lang CLI Commandlet.
...
* https://github.com/devonfw/IDEasy/issues/1752[#1752]: Fixed JSON merger to support JSONC (JSON with Comments) as used by VSCode settings
* https://github.com/devonfw/IDEasy/issues/1458[#1458]: ide create now implicitly changes to the new project directory
